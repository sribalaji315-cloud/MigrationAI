          ...
          {currentUser.role !== 'admin' && (
            <div className="mb-4 px-4 py-2.5 bg-amber-50 border border-amber-200 rounded-lg flex items-center gap-2">
              <svg className="w-4 h-4 text-amber-500 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M12 15v2m0 0v2m0-2h2m-2 0H10m-4.93-4A8 8 0 1120.93 13" />
              </svg>
              <span className="text-[10px] font-black text-amber-700 uppercase tracking-widest">Read-Only View — Contact an administrator to make changes</span>
            </div>
          )}
